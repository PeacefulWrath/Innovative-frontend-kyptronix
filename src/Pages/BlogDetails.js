...
import TestImg from "../assets/BannerImg.png";
      ...
      <div className={`${Styles.Blog__mainWrapper}`}>
        <div className={`${Styles.Blog__mainBlogWrapper}`}>
          ...
          <div className={`${Styles.Blog__mainContent}`}>
            ...
            <img className={`${Styles.Blog__blogDetailsImg}`} src={TestImg} alt="blog-related" />
        ...
        <div className={`${Styles.Blog__relativeBlogMainWrapper}`}>
          ...
          <div className={`${Styles.Blog__popularBlogMainWrapper}`}>
            ...
            <div className={`${Styles.relatedBlogLinkWrapper}`}>
              <Link to='/' className={`${Styles.Blog__links}`}>Maths</Link>
              <Link to='/' className={`${Styles.Blog__links}`}>English</Link>
              <Link to='/' className={`${Styles.Blog__links}`}>Biology</Link>
            </div>
          </div>
        </div>
      </div>
